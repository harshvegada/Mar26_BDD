...
public class FindFoodPage extends CommonPage {
    ...
    private final String RATING_FILTER_XPATH = "//select[@data-testid='rating-filter']";
    private final String RESTAURANT_FILTER_XPATH = "//select[@data-testid='restType-filter']";
...
//        return driver.findElements(By.xpath(RESTAURANT_GRID)).size();
    ...
    public void selectLocationFromAutoSuggestion(String locationText) {
...
//        locationSelect.selectByVisibleText(locationText);
    ...
    public void setRatingInDropdown(String rating) {
        selectByValueText(By.xpath(RATING_FILTER_XPATH), rating);
    }

    public void setRestaurantInDropdown(String resType) {
        selectByValueText(By.xpath(RESTAURANT_FILTER_XPATH), resType);
    }
